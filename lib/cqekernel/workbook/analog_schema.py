...
from ..stable_ids import analog_step_id
...
def _analog_step(
    ...
    return AnalogStep(
        step_id=analog_step_id(digital_equivalent, analog_action, expected_receipt),
        analog_action=analog_action,
        digital_equivalent=digital_equivalent,
